package tk.lorddarthart.domain.network.translator
...
import tk.lorddarthart.utils.network.translator.TranslatorNetwork
...
class YandexTranslate(private val context: Context) : TranslatorNetwork {
    ...
    override fun translateToLocale(text: String): String {
        ...
        con.setRequestProperty("connection", context.getString(R.string.requestPropertyConnection))
        con.setRequestProperty("content-type", context.getString(R.string.requestPropertyContentType))
